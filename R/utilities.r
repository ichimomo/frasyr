...
#' @param vpares VPAの結果のオブジェクト
#' @param refs_base est.MSYから得られる管理基準値の表
#' @param HCR.label.position HCRのラベルを書く位置。デフォルトはx軸方向が1, y軸方向が1の相対値です。様子を見ながら調整してください。
#'  @param refs.color 目標・限界・禁漁の線の色
#'  @param HCR.name 目標・限界・禁漁のラベルの名前
#'  @param Fratio ylab.type="F"のとき、F/Fmsyの時系列をここに入れる
#' 
#' @encoding UTF-8
#'
#' @export
