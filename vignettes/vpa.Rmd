...
=======
caa   <- read.csv("https://github.com/ichimomo/frasyr/blob/master/data-raw/ex2_caa.csv",  row.names=1)
waa   <- read.csv("https://github.com/ichimomo/frasyr/blob/master/data-raw/ex2_waa.csv",  row.names=1)
maa   <- read.csv("https://github.com/ichimomo/frasyr/blob/master/data-raw/ex2_maa.csv",  row.names=1)
dat <- data.handler(caa=caa, waa=waa, maa=maa, M=0.5)

# VPAによる資源量推定
res_vpa <- vpa(dat,fc.year=2015:2017,tf.year = 2015:2017,
...
=======
res_vpa2 <- read.vpa("https://github.com/ichimomo/frasyr/blob/master/data-raw/ex2_vpa.csv") # vpa.csvを編集後、read.vpa関数で読み込みます
>>>>>>> 07acd67cd1b870e640bfc8cb56065a43521ba244
```
...
=======
caa   <- read.csv("https://github.com/ichimomo/frasyr/blob/master/data-raw/ex1_caa.csv",  row.names=1)
waa   <- read.csv("https://github.com/ichimomo/frasyr/blob/master/data-raw/ex1_waa.csv",  row.names=1)
maa   <- read.csv("https://github.com/ichimomo/frasyr/blob/master/data-raw/ex1_maa.csv",  row.names=1)
M     <- read.csv("https://github.com/ichimomo/frasyr/blob/master/data-raw/ex1_M.csv",    row.names=1)
index <- read.csv("https://github.com/ichimomo/frasyr/blob/master/data-raw/ex1_index.csv",row.names=1)
>>>>>>> 07acd67cd1b870e640bfc8cb56065a43521ba244
