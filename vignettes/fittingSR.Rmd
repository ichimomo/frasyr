...
この再生産関係の妥当性はモデル選択によって検証する必要があります。説明は[再生産関係の決定に関するガイドライン](https://abchan.fra.go.jp/about/references_list/#s1)の付録、または、[frasyr_tool](https://github.com/ichimomo/frasyr_tool/tree/YR2025/SRcheck)(内部向け)を参照してください。
