...
# 全F推定法の場合
res_tmp <- vpa(vpadat_estb, tf.year=2015:2016, last.catch.zero = FALSE, 
...
res_tmp <- vpa(vpadat_estb, tf.year=2015:2016, last.catch.zero = FALSE, Pope = TRUE, 
...
res_vpa_jitter <- do_estcheck_vpa(res_vpa_estb, n_ite=20)
...
res_vpa_bootstrap <- plot_resboot_vpa(res_vpa_estb, B_ite = 50)
...
res_vpa_caaboot <- do_caaboot_vpa(res_vpa_estb, B_ite = 50)
