...
```{r, echo=FALSE}
# 事前準備（テストで使われているデータを使う）
# devtools::load_all("../frasyr/")
library(frasyr)
# 関数が実装され次第、以下のsource(コード)は不要
source("do_sensitivity_vpa.R")
source("do_retrospective_vpa.R")
source("do_estcheck_vpa.R")
source("plot_residual_vpa.R", encoding = "UTF-8")
source("do_jackknife_vpa.R")
