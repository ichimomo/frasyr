...
source("./tools/generate-testdata/future.r") # future.r 2019/12/18 ver.
source("./tools/generate-testdata/utilities.r") # utilities.r 2019/12/18 ver.
...
# future fcurrent ----
res_future_Fcurrent_pma_pre <- future.vpa(res_vpa_pma,
                                            multi=1,
                                            nyear=50, # 将来予測の年数
...
save(res_future_Fcurrent_pma_pre,file = "./inst/extdata/res_future_Fcurrent_pma_pre.rda")

# est MSY----
res_MSY_pma_pre <- est.MSY(res_vpa_pma, # VPAの計算結果
                             res_future_Fcurrent_pma_pre$input, # 将来予測で使用した引数
                             seed=res_future_Fcurrent_pma_pre$input$seed,
...
save(res_MSY_pma_pre,file = "./inst/extdata/res_MSY_pma_pre.rda")

# base ----
refs_all_pma_pre <- res_MSY_pma_pre$summary

refs_all_pma_pre$RP.definition[refs_all_pma_pre$RP_name=="MSY" & refs_all_pma$AR==FALSE] <- "Btarget0"
refs_all_pma_pre$RP.definition[refs_all_pma_pre$RP_name=="PGY_0.9_lower" & refs_all_pma_pre$AR==FALSE] <- "Blow0"
refs_all_pma_pre$RP.definition[refs_all_pma_pre$RP_name=="PGY_0.6_lower" & refs_all_pma_pre$AR==FALSE] <- "Blimit0"
refs_all_pma_pre$RP.definition[refs_all_pma_pre$RP_name=="PGY_0.1_lower" & refs_all_pma_pre$AR==FALSE] <- "Bban0"

refs_all_pma_pre$RP.definition[refs_all_pma_pre$RP_name=="B0-20%" & refs_all_pma$AR==FALSE] <- "Btarget1"  # たとえばBtargetの代替値としてB020%も候補に残しておきたい場合
refs_all_pma_pre$RP.definition[refs_all_pma_pre$RP_name=="PGY_0.95_lower" & refs_all_pma_pre$AR==FALSE] <- "Btarget2"
refs_all_pma_pre$RP.definition[refs_all_pma_pre$RP_name=="Ben-19431" & refs_all_pma$AR==FALSE] <- "Bcurrent"
refs_all_pma_pre$RP.definition[refs_all_pma_pre$RP_name=="Ben-63967" & refs_all_pma_pre$AR==FALSE] <- "Bmax"
refs_all_pma_pre$RP.definition[refs_all_pma_pre$RP_name=="Ben-24000" & refs_all_pma_pre$AR==FALSE] <- "Blimit1"
refs_all_pma_pre$RP.definition[refs_all_pma_pre$RP_name=="Ben-51882" & refs_all_pma_pre$AR==FALSE] <- "B_HS"

refs_all_pma_pre %>% dplyr::select(RP_name,RP.definition)

refs_base_pma_pre  <- refs_all_pma_pre %>%
...
save(refs_base_pma_pre,file = "./inst/extdata/refs_base_pma_pre.rda")
