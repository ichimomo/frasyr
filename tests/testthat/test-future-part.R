...
test_that("oututput value check", {
    ...
    #照合内容
    testcontents <- c("sel", "max.age", "min.age", "rps.q", "spr.q", "Fcurrent", "Fmed", "Flow", "Fhigh", "Fmax", "F0.1",
    "Fmean", "rps.data", "FpSPR", "summary", "ypr.spr", "waa", "waa.catch", "maa", "spr0")
...
test_that("oututput value check (iteration for future sim is fixed as 2)", {
    ...
    #照合内容
    testcontents <- c("faa", "naa", "wcaa", "M", "maa", "vbiom", "recruit", "eaa", "alpha", "thisyear.ssb", "waa",
    "waa.catch", "currentF", "vssb", "vwcaa", "naa_all", "years", "fyear.year", "ABC", "waa.year",
    "maa.year", "multi", "multi.year")
    ...
    #読み込んだ結果と照合
    for (i in 1 : length(testcontents)) {
        expect_equal(eval(parse(text = paste("fres_pma_HS_L1_AR0_outAR0$", testcontents[i]))),
        eval(parse(text = paste("fres_pma_HS_L1_AR0_outAR0_check$", testcontents[i]))), label = testcontents[i])
    }
    ...
    #読み込んだ結果と照合
    for (i in 1 : length(testcontents)) {
        expect_equal(eval(parse(text = paste("fres_pma_HS_L1_AR1_outAR1$", testcontents[i]))),
        eval(parse(text = paste("fres_pma_HS_L1_AR1_outAR1_check$", testcontents[i]))))
    }
    ...
    #読み込んだ結果と照合
    for (i in 1 : length(testcontents)) {
        expect_equal(eval(parse(text = paste("fres_pma_HS_L2_AR0_outAR0$", testcontents[i]))),
        eval(parse(text = paste("fres_pma_HS_L2_AR0_outAR0_check$", testcontents[i]))))
    }
    ...
    #読み込んだ結果と照合
    for (i in 1 : length(testcontents)) {
        expect_equal(eval(parse(text = paste("fres_pma_HS_L2_AR1_outAR0$", testcontents[i]))),
        eval(parse(text = paste("fres_pma_HS_L2_AR1_outAR0_check$", testcontents[i]))))
    }
    ...
    #読み込んだ結果と照合
    for (i in 1 : length(testcontents)) {
        expect_equal(eval(parse(text = paste("fres_pma_HS_L2_AR1_outAR1$", testcontents[i]))),
        eval(parse(text = paste("fres_pma_HS_L2_AR1_outAR1_check$", testcontents[i]))))
    }
    ...
    #読み込んだ結果と照合
    for (i in 1 : length(testcontents)) {
        expect_equal(eval(parse(text = paste("fres_pma_BH_L1_AR0_outAR0$", testcontents[i]))),
        eval(parse(text = paste("fres_pma_BH_L1_AR0_outAR0_check$", testcontents[i]))))
    }
    ...
    #読み込んだ結果と照合
    for (i in 1 : length(testcontents)) {
        expect_equal(eval(parse(text = paste("fres_pma_BH_L1_AR1_outAR0$", testcontents[i]))),
        eval(parse(text = paste("fres_pma_BH_L1_AR1_outAR0_check$", testcontents[i]))))
    }
    ...
    #読み込んだ結果と照合
    for (i in 1 : length(testcontents)) {
        expect_equal(eval(parse(text = paste("fres_pma_BH_L1_AR1_outAR1$", testcontents[i]))),
        eval(parse(text = paste("fres_pma_BH_L1_AR1_outAR1_check$", testcontents[i]))))
    }
